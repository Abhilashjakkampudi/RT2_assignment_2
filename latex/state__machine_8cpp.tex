...
This file will let the user interface comunicate with the go\+\_\+to\+\_\+point\+\_\+action.  
...
{\ttfamily \#include \char`\"{}rt2\+\_\+assignment1/go\+\_\+to\+\_\+point\+Action.\+h\char`\"{}}\newline
...
This node will be the bridge between the user interface, and the go\+\_\+to\+\_\+point\+\_\+action. It will receive commands from the user interface. It can elaborate new random target from the position\+\_\+server. It can start or stop the go\+\_\+to\+\_\+point\+\_\+action 
...
This function initializes everithing that is needed waits for commands and then performes the various requests to services and action \mbox{\Hypertarget{state__machine_8cpp_a1a9543636935547580c0657f4c7c0c2b}\label{state__machine_8cpp_a1a9543636935547580c0657f4c7c0c2b}} 
